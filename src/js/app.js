...
function iniciarApp() {
  /* Mostrar la seccion con el paso 1 */
  mostrarSeccion();
  ...
  consultarAPI();
  /* anade el id del cliente al objeto de cita */
  idCliente();
  /* anade el nombre del cliente al objeto de cita */
  nombreCliente();
  /* Anade la fecha de la cita en el objeto */
  seleccionarFecha();
  /* Anade la hora de la cita en el objeto */
  seleccionarHora();
